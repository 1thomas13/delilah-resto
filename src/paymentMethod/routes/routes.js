...
router.put("/:id/:paymentMethodid",middle.isLogged, middle.isAdmin, middle.delete_modifyMethod, modifyPaymentsMethod)

router.delete("/delete/:id/:paymentMethodid",middle.isLogged, middle.isAdmin, middle.delete_modifyMethod, deletePaymentMethod)
